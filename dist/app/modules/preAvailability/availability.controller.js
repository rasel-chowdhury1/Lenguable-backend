...
const createAvailability = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield availability_service_1.AvailabilityService.createAvailability(userId, Object.assign(Object.assign({}, req.body), { timezone }));
...
const getMyAvailability = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user.userId;
    const timezone = req.query.timezone;
    const result = yield availability_service_1.AvailabilityService.getMyAvailability(userId, timezone);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const updateSlot = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const timezone = req.query.timezone;
    const result = yield availability_service_1.AvailabilityService.updateSlot(userId, availabilityId, slotId, Object.assign(Object.assign({}, req.body), { timezone }));
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
...
const deleteSlot = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user.userId;
    const { availabilityId, slotId } = req.params;
    const result = yield availability_service_1.AvailabilityService.deleteSlot(userId, availabilityId, slotId);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
...
const searchTeachers = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield availability_service_1.AvailabilityService.searchTeachersByAvailability(date, time, timezone);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
...
const getAllAvailability = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const timezone = req.query.timezone;
    const result = yield availability_service_1.AvailabilityService.getAllAvailability(timezone);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
